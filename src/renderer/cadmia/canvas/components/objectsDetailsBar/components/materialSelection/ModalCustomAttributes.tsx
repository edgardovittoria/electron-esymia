      ...
      <Dialog as="div" className="relative z-50" onClose={() => { }}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-[1200px] h-[650px] mt-14 bg-white transform overflow-hidden rounded-2xl p-6 text-left align-middle shadow-xl transition-all">
                      ...
                      <div className="w-1/3">
                        <button
                          ...
                          onClick={() => {
                            setCustomAttribute({
                              frequencies: [
                                ...customAttribute.frequencies,
                                frequency,
                              ],
                              values: [
                                ...customAttribute.values,
                                { Re: valuesRE, Im: valuesIm },
                              ],
                            });
                            setFrequency(0);
                            setValuesRE(0);
                          ...
                          {customAttribute.frequencies.map((value, index) => {
                            return (
                              <tr key={index}>
                                ...
                                <td>
                                  <button
                                    className="btn w-[59%] h-[2rem] min-h-[2rem] bg-red-500 hover:cursor-pointer hover:opacity-70"
                                    onClick={() => {
                                      setCustomAttribute({
                                        frequencies:
                                          customAttribute.frequencies.filter(
                                            (f, ind) => ind !== index,
                                          ),
                                        values: customAttribute.values.filter(
                                          (v, ind) => ind !== index,
                                        ),
                                      });
                                    }}
