...
exports.mean_length_Lp = mean_length_Lp;
/**
...
function mean_length_Lp(barra1, curr_dir) {
    ...
    var rai = [
        0.125 * (-ri[0][0] + ri[1][0] + ri[3][0] - ri[2][0]
            - ri[4][0] + ri[5][0] + ri[7][0] - ri[6][0]),
        0.125 * (-ri[0][1] + ri[1][1] + ri[3][1] - ri[2][1]
            - ri[4][1] + ri[5][1] + ri[7][1] - ri[6][1]),
        0.125 * (-ri[0][2] + ri[1][2] + ri[3][2] - ri[2][2]
