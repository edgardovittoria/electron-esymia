...
exports.importRisGeometry =
  exports.importFromCadProject =
  exports.importFromCadSTL =
    void 0;
...
var checkRisImport = require('./checkRisImport');
var isRisModelValid = checkRisImport.isRisModelValid;
...
var importFromCadProject = function (
  file,
  dispatch,
  action,
  actionParamsObject,
...
var importRisGeometry = function (file, dispatch, numberOfGeneratedKey) {
  file.text().then(function (value) {
    var { geometry, isModelValid, message } = isRisModelValid(value);
    if (isModelValid) {
      var data = geometry.map((box) => [box.xMin, box.xMax, box.yMin, box.yMax, box.zMin, box.zMax]);
      var key = (0, cube_1.getNewKeys)(
