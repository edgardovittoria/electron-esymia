...
export const CreatePorts: React.FC<SelectPortsProps> = ({selectedProject, cameraPosition}) => {
    ...
    return (
        <>
            < div className={`border rounded ${theme === 'light' ? 'bg-white text-textColor border-textColor' : 'bg-bgColorDark2 text-textColorDark border-textColorDark'} ${(selectedProject.simulation?.status === 'Completed') && 'opacity-40'}`}>
