    ...
    <>
      ...
      <nav className="flex w-full justify-between px-8 pt-6 h-[6vh]">
        <div className="flex items-center h-max">
          <a className="text-black text-2xl font-semibold mr-4 ml-4" href="/">
            ESimIA
          </a>
            ...
            <li
              className={
                tabSelected === 'DASHBOARD'
                  ? `px-3 py-3 bg-white rounded-tl text-black flex justify-between items-center gap-2`
                  : `bg-[#dadada] rounded flex items-center px-3 py-3 hover:cursor-pointer`
              }
              onClick={() => {
            ...
            {projectsTabs.map((projectTab) => {
              return (
                <li
                  ...
                  className="bg-[#dadada] rounded-tr"
                >
                  <div
                    className={
                      tabSelected === projectTab.faunaDocumentId
                        ? 'px-3 py-3 bg-white flex items-center'
                  ...
                  >
                    <div
                      ...
                      onClick={() => {
                        dispatch(
                          selectTab(projectTab.faunaDocumentId as string),
                        );
